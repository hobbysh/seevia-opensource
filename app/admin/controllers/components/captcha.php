...
class CaptchaComponent extends Object
{
    ...
    public $_image_width = 70; //the width of the captcha image
    ...
    public $_text_minimum_distance = 18; //minimum distance for spacing between letters in pixels
    public $_text_x_start = 2; //the x-position on the image where letter drawing will begin
