...
<div>   
	<div class="am-text-right  am-btn-group-xs" style="margin-right:10px;margin-bottom:10px">
		<?php echo $html->link($ld['region'].$ld['region_view'],'/regions',array("class"=>"am-btn am-btn-default am-btn-sm"),'',false,false).'&nbsp;';?>
		<a class="am-btn am-btn-warning am-btn-sm am-radius" href="<?php echo $html->url('/regions/view/'); ?>">
	...
	<div>
		<div class="am-u-lg-2 am-u-md-3 am-u-sm-4">
			<ul class="am-list admin-sidebar-list" data-am-scrollspy-nav="{offsetTop: 45}" style="position: fixed; z-index: 100; width: 15%;max-width:200px;">
		    	<li><a href="#batch_upload_user"><?php echo $ld['bulk_upload'].$ld['region'] ?></a></li>
		...
		<div class="am-panel-group admin-content" id="accordion" style="width:83%;float:right;">
			<?php echo $form->create('regions',array('action'=>'/csv_add/','name'=>"uploadusersForm","enctype"=>"multipart/form-data"));?>
				<div id="batch_upload_user" class="am-panel am-panel-default">
			  		<div class="am-panel-hd">
						<h4 class="am-panel-title">
							<?php echo $ld['bulk_upload'].$ld['region'] ?>
						</h4>
				    </div>
								...
								<div class="am-form-group">
					    			...
					    			<div class="am-u-lg-6 am-u-md-6 am-u-sm-6">
					    				<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
											<?php echo $html->link($ld['download_example_batch_csv'],"/regions/upload_csv/",'',false,false);?>
					    				</div>
					    			</div>
					    		</div>	
