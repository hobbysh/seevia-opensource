...
/**
 * Allinone Install program language file
 * ============================================================================
 ...
 * ============================================================================
 * $Author: liuhui $
 * $Id: en_us.php 1372 2016-01-14 05:24:38Z zhaoyincheng $
 */
...
$_LANG['copyright'] = '&copy; 2005-2010 <a href="http://www.seevia.cn/" target="_blank">Shanghai Shi Wei Network Technology Co., Ltd.</a> <br> All right reserved.';


/* Welcome page */
$_LANG['welcome_title'] = 'You are welcome to use the Allinone e-commerce management system!';
...
$_LANG['checking_title'] = 'Allinone install program, the 2 step / 3 steps, check enviroment';
...
/* Config system */
$_LANG['setting_title'] = 'Allinone install program, the 3 step / 3 step, config system';
...
$_LANG['default_friend_link'] = 'Allinone e-commerce management system';
...
/* Prompting message */
$_LANG['has_locked_installer'] = '<strong>Install program has locked.</strong><br /><br />If you confirm reinstall Allinone, please delete install.lock in data directory.';
...
$_LANG['install_done_title'] = 'Allinone install program, install successfully.';
$_LANG['install_error_title'] = 'Allinone install program, install failed.';
$_LANG['done'] = 'Congratulation，Allinone has installed successfully.<br />Based on security consideration, please delete install directory at once.';
$_LANG['go_to_view_my_ecshop'] = 'Allinone Homepage';
$_LANG['go_to_view_control_panel'] = 'Allinone Control panel';
