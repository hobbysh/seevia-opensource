 ...
 * ============================================================================
 * $Author: liuhui $
 * $Id: zh_cn.php 1372 2016-01-14 05:24:38Z zhaoyincheng $
 */
...
/* 欢迎页 */
$_LANG['welcome_title'] = '欢迎您选用Allinone网上商店管理系统！';
...
/* 环境检测页 */
$_LANG['checking_title'] = 'Allinone安装程序 第2步/共3步 环境检测';
...
/* 系统设置 */
$_LANG['setup'] = '填写完毕';
$_LANG['setting_title'] = 'Allinone安装程序 第3步/共3步 配置系统';
...
$_LANG['default_friend_link'] = 'Allinone 网上商店管理系统';
...
/* 提示信息 */
$_LANG['has_locked_installer'] = '<strong>安装程序已经被锁定。</strong><br /><br />如果您确定要重新安装 Allinone，请删除data目录下的 install.lock。';
...
$_LANG['install_done_title'] = 'Allinone 安装程序 安装成功';
$_LANG['install_error_title'] = 'Allinone 安装程序 安装失败';
$_LANG['done'] = '恭喜您，Allinone 已经成功地安装完成。<br />基于安全的考虑，请在安装完成后删除 install 目录。';
$_LANG['go_to_view_my_ecshop'] = '前往 Allinone 首页';
$_LANG['go_to_view_control_panel'] = '前往 Allinone 后台管理中心';
