 ...
 * ============================================================================
 * $Author: liuhui $
 * $Id: zh_tw.php 1372 2016-01-14 05:24:38Z zhaoyincheng $
 */
...
$_LANG['prev_step'] = '上一步：';
$_LANG['next_step'] = '下一步：';
$_LANG['copyright'] = '&copy; 2014 <a href="http://www.seevia.cn/" target="_blank">上海实玮网络科技有限公司</a>。版权所有。';


/* 歡迎頁 */
$_LANG['welcome_title'] = '歡迎您選用Allinone網上商店管理系統！';
...
/* 環境檢測頁 */
$_LANG['checking_title'] = 'Allinone安裝程序 第2步/共3步 環境檢測';
...
/* 系統設置 */
$_LANG['setup'] = '填寫完畢';
$_LANG['setting_title'] = 'Allinone安裝程序 第3步/共3步 配置系統';
...
$_LANG['default_friend_link'] = 'Allinone 網上商店管理系統';
...
/* 提示信息 */
$_LANG['has_locked_installer'] = '<strong>安裝程序已經被鎖定。</strong><br /><br />如果您確定要重新安裝 Allinone，請刪除data目錄下的 install.lock。';
...
$_LANG['install_done_title'] = 'Allinone 安裝程序 安裝成功';
$_LANG['install_error_title'] = 'Allinone 安裝程序 安裝失敗';
$_LANG['done'] = '恭喜您，Allinone 已經成功地安裝完成。<br />基於安全的考慮，請在安裝完成後刪除 install 目錄。';
$_LANG['go_to_view_my_ecshop'] = '前往 Allinone 首頁';
$_LANG['go_to_view_control_panel'] = '前往 Allinone 後台管理中心';
